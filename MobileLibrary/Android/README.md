...
repositories {
    ...
    maven {
        url "https://raw.github.com/astaguna/popon-core-Android-library/master"
    }
}
```
...
```
Where x.y.z is the target version. Latest available release version can be found at https://github.com/astaguna/popon-core-Android-library
...
cd ../.. && \
  ...
  psiandroid \
  /bin/bash -c 'cd /go/src/github.com/astaguna/popon-core/MobileLibrary/Android && ./make.bash' \
; cd -
```
