...
TUNNEL_CORE_SRC_DIR=${GOPATH}/src/github.com/astaguna/popon-core
...
ln -s "${BASE_DIR}/../.." "${GOPATH}/src/github.com/astaguna/popon-core"
if [[ $? != 0 ]]; then
  echo "ln -s ../.. ${GOPATH}/src/github.com/astaguna/popon-core"
  exit 1
fi
...
function gomobile_build_for_platform() {
  ...
  -tags="${BUILD_TAGS}" \
  -ldflags="${LDFLAGS}" \
  -o "${GOBIND_OUT}" github.com/astaguna/popon-core/MobileLibrary/psi
...
cp -R "${GOPATH}/src/github.com/astaguna/popon-core/MobileLibrary/go-mobile" "${GOPATH}/src/golang.org/x/mobile"
...
-s \
-w \
-X github.com/astaguna/popon-core/psiphon/common/buildinfo.buildDate=${BUILDDATE} \
-X github.com/astaguna/popon-core/psiphon/common/buildinfo.buildRepo=${BUILDREPO} \
-X github.com/astaguna/popon-core/psiphon/common/buildinfo.buildRev=${BUILDREV} \
-X github.com/astaguna/popon-core/psiphon/common/buildinfo.goVersion=${GOVERSION} \
"
