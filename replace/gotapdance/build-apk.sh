...
git clone https://github.com/astaguna/popon-core.git $GOPATH/src/github.com/astaguna/popon-core
cd $GOPATH/src/github.com/astaguna/popon-core && git checkout -b build-refraction-networking


go get github.com/kardianos/govendor
cd $GOPATH/src/github.com/astaguna/popon-core && $GOPATH/bin/govendor remove github.com/refraction-networking/gotapdance/...

sed -i.bak 's/refraction_networking_tapdance.Logger().Out = ioutil.Discard//' $GOPATH/src/github.com/astaguna/popon-core/psiphon/common/tapdance/tapdance.go
...
patch $GOPATH/src/github.com/astaguna/popon-core/psiphon/common/tapdance/tapdance.go build/conjure.golang.patch

echo "digesting..."
# Digest this branch's ClientConf into Psiphon's embedded_config
./test_scripts/psiphon_digest_cc.sh ./assets/ClientConf $GOPATH/src/github.com/astaguna/popon-core/psiphon/common/tapdance/embedded_config.go

echo "Conjure APK script"
cd $REPO_DIR

# Build Psiphon Android Library ca.psiphon.aar
#docker run -v $DOCKER_DIR:$GOPATH/go/src/github.com/refraction-networking/gotapdance -v $GOPATH/src/github.com/astaguna/popon-core:$GOPATH/go/src/github.com/astaguna/popon-core refraction/psiandroid /bin/bash -c 'cd $GOPATH/src/github.com/astaguna/popon-core/MobileLibrary/Android && ./make.bash "TAPDANCE"'
docker run -v $REPO_DIR:/go/src/github.com/refraction-networking/gotapdance -v $GOPATH/src/github.com/astaguna/popon-core:/go/src/github.com/astaguna/popon-core refraction/psiandroid /bin/bash -c 'cd /go/src/github.com/astaguna/popon-core/MobileLibrary/Android && ./make.bash "TAPDANCE"'

echo "moving .aar"
cd $GOPATH/src/github.com/refraction-networking/gotapdance
mv $GOPATH/src/github.com/astaguna/popon-core/MobileLibrary/Android/ca.psiphon.aar build/
